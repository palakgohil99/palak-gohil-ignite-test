<template>
    <div class="h-screen w-screen overflow-hidden bg-[#f7f5ff] text-gray-900 flex flex-col">
        ...
        <!-- Header -->
        <header ref="headerRef" class="pt-10 pb-6 text-center px-4 flex-shrink-0">
        ...
        <main ref="mainRef"
            ...
            <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 p-6 pb-12">
                <CategoryCard v-for="cat in categories" :key="cat.id" :label="truncate(cat.name)" :title="cat.name"
